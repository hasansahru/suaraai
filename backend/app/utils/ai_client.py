...
def build_user_content(
    ...
    if shot_count:
        ...
        out.append(
            ...
            f"WAJIB HUKUMNYA: Total akumulasi durasi dari awal (00:00) hingga babak/chapter terakhir di `video_panjang.strategi_konten.outline` (field `end_estimate` babak terakhir) HARUS BERAKHIR TEPAT di dalam rentang {target_min_seconds or 0}-{target_max_seconds or 0} detik ({duration_desc}). DILARANG KERAS babak terakhir selesai di bawah {target_min_seconds or 0} detik! "
