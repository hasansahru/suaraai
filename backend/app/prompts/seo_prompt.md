...
1. **Deskripsi YouTube** — 3–5 paragraf singkat (atau 1 paragraf + bullet point untuk Shorts), berisi:
   ...
   - **Khusus Video Panjang (WAJIB)**: Sertakan daftar **Timestamp / Daftar Chapter SEO** (format `00:00:00 - Nama Babak` atau `hh:mm:ss - Nama Babak`) di bagian akhir deskripsi, yang secara tepat memetakan seluruh babak dari outline video baru mulai dari `00:00:00` sampai durasi target video yang dipilih! Ini wajib agar video otomatis terbagi menjadi chapter di YouTube.
