...
2. **Keyword Utama** — 1–3 keyword inti dengan volume pencarian tertinggi. Pilih frasa pencarian solusi yang biasa diketik oleh orang asli di kolom pencarian YouTube (contoh: "cara mengatasi cemas berlebih", "filosofi stoikisme hidup santai", bukan bahasa teknis yang kaku).
3. **Keyword Turunan** — 5–10 keyword/related search terms (long-tail keywords) yang melengkapi keyword utama secara semantik untuk menangkap lalu lintas pencarian yang lebih luas.
