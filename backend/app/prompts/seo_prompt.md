...
1. **Deskripsi YouTube** — 3–5 paragraf singkat (atau 1 paragraf + bullet point untuk Shorts), berisi:
   ...
   - **Khusus Video Panjang (WAJIB)**: Sertakan daftar **Timestamp / Daftar Chapter SEO** (format `00:00 - Nama Babak` atau `hh:mm:ss - Nama Babak`) di bagian akhir deskripsi, yang secara tepat memetakan seluruh babak dari outline video baru mulai dari `00:00` sampai durasi target video yang dipilih! Ini wajib agar video otomatis terbagi menjadi chapter di YouTube.
   - Baris hashtag singkat di akhir (boleh duplikat dengan beberapa hashtag pada poin 5).
2. **Keyword Utama** — 3–5 keyword utama (pisahkan dengan koma) dengan volume pencarian tertinggi. Pilih frasa pencarian solusi yang biasa diketik oleh orang asli di kolom pencarian YouTube (contoh: "cara mengatasi cemas berlebih", "filosofi stoikisme hidup santai", bukan bahasa teknis yang kaku).
3. **Keyword Turunan** — 8–15 keyword/related search terms (long-tail keywords) yang melengkapi keyword utama secara semantik untuk menangkap lalu lintas pencarian yang lebih luas.
